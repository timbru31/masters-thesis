...
\newcommand{\keywordsGer}[1]{\textbf{\textit{Schlüsselwörter---}} #1}
...
\addtocategory{badbreaks}{bundesnetzagentur}
\addtocategory{badbreaks}{email-encryption}
\addtocategory{badbreaks}{fido-certification}
\addtocategory{badbreaks}{fido-history}
\addtocategory{badbreaks}{u2f-js-api}
\addtocategory{badbreaks}{uaf-asm}
\addtocategory{badbreaks}{uaf-auth-commands}
\addtocategory{badbreaks}{troy-hunt-1}
\addtocategory{badbreaks}{yubico-otp}
\addtocategory{badbreaks}{statcounter-desktop}
\addtocategory{badbreaks}{statcounter-global}
...
\newcommand{\listofloename}{List of Listings}

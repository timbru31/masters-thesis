...
A widely used method of authentication in order to achieve \gls{mfa} are \glspl{otp} which belong to the category of possession of a shared secret between the client and the server.
...
The \glsfirst{hotp} is again an extension of the \gls{hotp} that is time-based instead of counter-based. It's a joint effort of the \gls{ietf} and the \gls{oath}, too, resulting in a standardization in \gls{rfc} 6238.\footcite[See][]{m2011rfc}

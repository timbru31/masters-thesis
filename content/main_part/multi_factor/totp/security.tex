...
Another variant that is technically more complex, but feasible, is the \gls{sim} card cloning. This allows the attacker to intercept the \gls{totp}, too. Even if the phone number can not be registered twice, it still enables the eavesdropping.\footcites[See][873]{eckert-it-sec-9}[See][11--12]{sim-clone}

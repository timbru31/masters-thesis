...
Because \gls{u2f} relies on the web in contrast to the \gls{uaf} protocol, web browser support has to be taken into account. Due to the fact, that \gls{u2f} is superseded by \gls{fido}2, the web browser support of \gls{u2f} is not of interest for this thesis.

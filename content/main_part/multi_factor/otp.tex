...
The \glsfirst{hotp} is again an extension of the \gls{hotp} that is time-based instead of counter-based. It is a joint efforts of the \gls{ietf} and the \gls{oath}, too, resulting in standardization in \gls{rfc} 6238.\footcite[See][]{m2011rfc}

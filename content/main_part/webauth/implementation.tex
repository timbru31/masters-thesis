...
\end{table}
\footnotetext{Sources: \footcites{chrome-webauthn}{firefox-webauthn}{safari-webauthn}{chrome-android-webauthn}{firefox-android-webauthn}. A detailed analysis of Android browsers is available on the CD in the appendix.}
\newpage

...
Hereupon the \wa{} is introduced in chapter \ref{chapter:webauth} and described in detail. The technical functionality is a key aspect of this chapter. Additionally, the attacks the \wa{} can offer protection against are explained but also asserted which security risks exist, too. Where suitable example source code listings are used to highlight these analyses.% TODO or POC?
